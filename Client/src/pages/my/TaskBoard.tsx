...
function TaskBoard() {
  ...
  return (
    <main className="overflow-hidden flex flex-row h-[94vh]">
      <aside className="absolute w-full  h-[50rem] bg-gradient-to-br from-pink-400 to-blue-500 dark:from-purple-400 dark:to-red-600 rounded-md filter blur-3xl opacity-60 -z-10"></aside>
      <TaskSideBar />
