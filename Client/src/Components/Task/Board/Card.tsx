...
function ColumnCard({
  ...
  return (
    <div
      className="bg-white dark:bg-zinc-700/60 rounded-md space-y-2 drop-shadow-md hover:bg-zinc-200 active:bg-zinc-300 dark:hover:bg-zinc-600 dark:active:bg-zinc-500/70 h-auto"
      {...dragHandleProps}
      {...draggableProps}
      ref={innerRef}
    >
