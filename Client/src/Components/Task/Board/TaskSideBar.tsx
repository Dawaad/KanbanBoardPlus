...
function TaskSideBar() {
  return (
    <section className="w-[2.5rem] hover:w-[20rem] bg-zinc-200/40 dark:bg-zinc-800/50  transition-all  ">
      <section
      ...
      >
        ...
        <div className="flex items-center overflow-hidden hover:bg-zinc-400/30 hover:dark:bg-zinc-500/30">
